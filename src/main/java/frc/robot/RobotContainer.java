...
private final Joystick joystick1 = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    m_autoChooser.addOption("Vision Auto (1 cube)", new VisionAuto(m_tankDrive, m_elevator, m_pneumaticArm, m_pneumaticGrabber, m_grabberExtension));
    m_goalChooser.addOption("Goal 1 (to your right)", 1);
    // SmartDashboard Buttons
    SmartDashboard.putData("VisionAuto", new VisionAuto(m_tankDrive, m_elevator, m_pneumaticArm, m_pneumaticGrabber, m_grabberExtension));
    ...
    m_tankDrive.setDefaultCommand(new Drive(0, m_tankDrive, joystick1));
  ...
  //  m_autoChooser.setDefaultOption("$command.getName()", new ${name.replace(' ', '')}( m_${name.substring(0,1).toLowerCase()}${name.substring(1).replace(' ', '')} ));
  ...
  public void startRevSim() {
    //REVPhysicsSim.getInstance().addSparkMax(m_tankDrive.driveMotorLeft, DCMotor.getNEO(1));
    //REVPhysicsSim.getInstance().addSparkMax(m_tankDrive.driveMotorRight, DCMotor.getNEO(1));
...
public Joystick getJoystick1() {
  ...
  */
  ...
  public Integer getGoal() {
    // The selected goal will be targeted in autonomous
    return m_goalChooser.getSelected();
  }
